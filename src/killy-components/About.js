...
const About = () => { 
    ...
    return (
        <>
                    ...
                    <div className="container" data-aos="fade-up">
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <img src={"theme-assets/img/about.jpg"} className="img-fluid" alt="" />
                            </div>
                            <div className="col-lg-8 pt-4 pt-lg-0 content">
                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <ul>
                                            <li><i className="bi bi-rounded-right"></i> <strong>Birthday:</strong> 1 May
                                                1995
                                            </li>
                                            <li><i className="bi bi-rounded-right"></i>
                                                <strong>Website:</strong> www.example.com
                                            </li>
                                            <li><i className="bi bi-rounded-right"></i> <strong>Phone:</strong> +123 456
                                                7890
                                            </li>
                                            <li><i className="bi bi-rounded-right"></i> <strong>City:</strong> City :
                                                New York, USA
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="col-lg-6">
                                        <ul>
                                            ...
                                            <li><i className="bi bi-rounded-right"></i> <strong>Degree:</strong> Master
                                            </li>
                                            <li><i className="bi bi-rounded-right"></i>
                            ...
                            <div className="swiper-wrapper">
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        <img src={"theme-assets/img/testimonials/testimonials-1.jpg"}
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        <img src={"theme-assets/img/testimonials/testimonials-2.jpg"}
                                             className="testimonial-img" alt="" />
                                            <h3>Sara Wilsson</h3>
                                            <h4>Designer</h4>
                                            <p>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        <img src={"theme-assets/img/testimonials/testimonials-3.jpg"}
                                             className="testimonial-img" alt="" />
                                            <h3>Jena Karlis</h3>
                                            <h4>Store Owner</h4>
                                            <p>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        <img src={"theme-assets/img/testimonials/testimonials-4.jpg"}
                                             className="testimonial-img" alt="" />
                                            <h3>Matt Brandon</h3>
                                            <h4>Freelancer</h4>
                                            <p>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-item">
                                        <img src={"theme-assets/img/testimonials/testimonials-5.jpg"}
                                             className="testimonial-img" alt="" />
                                            <h3>John Larson</h3>
                                            <h4>Entrepreneur</h4>
                                            <p>
            ...
            <Helmet>
                <script src="public/theme-assets/vendor/purecounter/purecounter_vanilla.js" type="text/jsx" crossOrigin="anonymous" /> 
            </Helmet>
        </>
    );
};
